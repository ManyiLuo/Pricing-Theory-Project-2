function [pnlTimeBased, pnlMoveBased] = DeltaHedge(S0, mu, rf, sigma, T, pos, K, OptType, trans, DDelta, Nsims, Nsteps, MakeSamplePathPlot)
    ...
    qtl1 = quantile(pnlTimeBased, 0.999);
    qtl2 = quantile(pnlTimeBased, 0.001);
